...
\usepackage{xparse}
\DeclareDocumentCommand\topic{ m m}
{
\begin{tcolorbox}[sidebyside,sidebyside align=top,opacityframe=0,opacityback=0,opacitybacktitle=0, opacitytext=1,lefthand width=.2\textwidth]
\begin{tcolorbox}[colback=white,colframe=white,sidebyside align=top,width=\textwidth,before skip=0pt]
#1.\end{tcolorbox}%
\tcblower
\begin{tcolorbox}[colback=white,colframe=blue!10,width=\textwidth,before skip=0pt]
#2
\end{tcolorbox}
...
\\Sheldon: Bye-bye
\\Leonard: See you.
\\{\Large \textbf{Scene: The stairs of the apartment building.
